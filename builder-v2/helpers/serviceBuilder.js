...
function buildFileContent(respuestas) {
  ...
  // Export an object containing the service functions
  ...
  /**
   * 
   * @param {Object} itemRequest - The request object containing parameters for fetching records.
  ...
  /**
   * 
   * @param {Model} itemRequest - The model object containing data to be saved.
   * @returns {Promise} - A promise that resolves to the server response.
   */
  ...
  /**
   * 
   * @param {Model} itemRequest - The model object containing updated data.
   * @returns {Promise} - A promise that resolves to the server response.
   */
  function updateRecord(itemRequest) {
      const requestOptions = {
